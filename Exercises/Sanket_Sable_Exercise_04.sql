...
CREATE TABLE Salaries (
    ...
    UNIQUE (emp_id, effective_date)
);

drop table salaries;

INSERT INTO Salaries (emp_id, salary_amount, effective_date) VALUES
...
-- 1. Select specific columns
select emp_id, salary_amount, effective_date from salaries;
...
-- 2. Update salary for all employee 
update salaries
set salary_amount = salary_amount * 2;

-- 3. Update specific date in table
update salaries
set effective_date = '2025-01-15'
where emp_id = 5;

-- 4. update a salary for multiple employee
update salaries
...
update salaries
set effective_date = '2025-02-05'
where emp_id in ('3','5','6');