...
select DepartmentID, DepartmentName, Email from Departments;

-- add new column
alter table Departments 
add column DepartmentHead_Gender varchar(10);

-- drop column
alter table Departments
drop column DepartmentHead_Gender;
...
You can drop a check constraints if you want to remove the condition on a column.
*/
...
Operators help in computations, comparisons, logical evaluations
